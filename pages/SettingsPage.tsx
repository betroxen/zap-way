                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <div className="flex gap-3">
                                    <Input value="ShadowEdge42" readOnly className="font-mono bg-[#14131c] border-[#3a3846] text-white font-bold" />
                                    <Button variant="secondary" size="sm" className="shrink-0 font-mono uppercase text-xs border-[#333] hover:border-[#00FFC0]">Edit Handle</Button>
                                </div>
                            </div>
                            <div>
                                <label className="block text-xs font-mono text-[#00FFC0] uppercase mb-2">Verified Email</label>
                                <div className="flex gap-3">
                                    <Input type="email" value="edge@zap.gg" readOnly className="font-mono bg-[#14131c] border-[#3a3846] text-[#8d8c9e]" />
                                    <Button variant="secondary" size="sm" className="shrink-0 font-mono uppercase text-xs border-[#333] hover:border-[#00FFC0]">Update Email</Button>
                                </div>
                            </div>
                        </div>
                ...
                <section id="security">
                    ...
                    <Card className="p-6 md:p-8 bg-[#0c0c0e] border-[#3a3846]">
                        <div className="flex justify-between items-center mb-8 pb-6 border-b border-[#333]">
                            ...
                            <Button variant="secondary" size="sm" className="font-mono uppercase text-xs border-[#333]">CHANGE PASSWORD</Button>
                        </div>

                        <div className="space-y-2 divide-y divide-[#333]/50">
                            <Toggle 
                                checked={mfaActive} onChange={setMfaActive} 
                            ...
                            />
                             <Toggle 
                                checked={highSecLogs} onChange={setHighSecLogs} 
                            ...
                            />
                             <Toggle 
                                checked={geoMonitor} onChange={setGeoMonitor} 
                            ...
                            />
                             <Toggle 
                                checked={autoTerminate} onChange={setAutoTerminate} 
                            ...
                            />
                             <Toggle 
                                checked={hardLock} onChange={setHardLock} 
                        ...
                        <div className="mt-8 pt-6 border-t border-[#333] flex flex-col md:flex-row justify-between items-center gap-6">
                            <div className="flex-1 w-full">
                                ...
                                <div className="bg-[#14131c] p-3 rounded border border-[#333] font-mono text-xs flex justify-between items-center">
                                    ...
                                    <button className="text-red-500 hover:text-white hover:underline uppercase">TERMINATE OTHERS</button>
                                </div>
                            </div>
                            <Button variant="secondary" className="shrink-0 border-red-900/30 text-red-400 hover:border-red-500 hover:text-red-500 font-mono uppercase text-xs">
                ...
                <section id="privacy">
                    ...
                    <Card className="p-6 md:p-8 bg-[#0c0c0e] border-[#3a3846]">
                        ...
                        <div className="divide-y divide-[#333]/50 mb-8">
                            <Toggle 
                                checked={anonymizedAnalytics} onChange={setAnonymizedAnalytics} 
                            ...
                            />
                            <Toggle 
                                checked={affiliateTracking} onChange={setAffiliateTracking} 
                            ...
                            />
                            <Toggle 
                                checked={contributionDisplay} onChange={setContributionDisplay} 
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 p-4 bg-[#14131c] rounded-lg border border-[#333]">
                            <Button variant="secondary" className="font-mono uppercase text-xs tracking-wider flex items-center gap-2 border-[#333] hover:border-[#00FFC0]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div className="flex p-1 bg-[#14131c] rounded-md border border-[#333]">
                                    <button onClick={() => setAestheticMode('dark')} className={`flex-1 py-2 text-xs font-heading uppercase rounded-sm transition-all ${aestheticMode === 'dark' ? 'bg-[#333] text-white' : 'text-[#8d8c9e] hover:text-white'}`}>DARK OPS</button>
                                    <button onClick={() => setAestheticMode('light')} className={`flex-1 py-2 text-xs font-heading uppercase rounded-sm transition-all ${aestheticMode === 'light' ? 'bg-white text-black' : 'text-[#8d8c9e] hover:text-white'}`}>LIGHT (BETA)</button>
                                </div>
                            </div>
                             <div>
                                <label className="block text-xs font-mono text-[#8d8c9e] uppercase mb-3">Data View Format</label>
                                <div className="flex p-1 bg-[#14131c] rounded-md border border-[#333]">
                                    <button onClick={() => setDataViewFormat('percentage')} className={`flex-1 py-2 text-xs font-heading uppercase rounded-sm transition-all ${dataViewFormat === 'percentage' ? 'bg-[#00FFC0]/20 text-[#00FFC0]' : 'text-[#8d8c9e] hover:text-white'}`}>96.5%</button>
                                    <button onClick={() => setDataViewFormat('decimal')} className={`flex-1 py-2 text-xs font-heading uppercase rounded-sm transition-all ${dataViewFormat === 'decimal' ? 'bg-[#00FFC0]/20 text-[#00FFC0]' : 'text-[#8d8c9e] hover:text-white'}`}>0.965</button>
                                </div>
                            </div>
                             <div>
                                <label className="block text-xs font-mono text-[#8d8c9e] uppercase mb-3">Primary Language</label>
                                <select value={language} onChange={(e) => setLanguage(e.target.value)} className="w-full h-[42px] bg-[#14131c] border border-[#333] rounded-md px-3 text-xs font-heading uppercase text-white focus:outline-none focus:border-[#00FFC0]">
                ...
                <section id="notifications">
                    ...
                    <Card className="p-6 md:p-8 bg-[#0c0c0e] border-[#3a3846]">
                        <div className="space-y-2 divide-y divide-[#333]/50">
                            ...
                            <Toggle 
                                checked={emailIntel} onChange={setEmailIntel} 
                            ...
                            />
                            <Toggle 
                                checked={communitySignal} onChange={setCommunitySignal} 
                            ...
                            />
                             <Toggle 
                                checked={marketingComm} onChange={setMarketingComm} 
