...
export const AccordionTrigger: React.FC<AccordionTriggerProps> = ({ children }) => {
  ...
  if (!accordionContext) throw new Error("AccordionTrigger must be used within an Accordion");
...
export const AccordionContent: React.FC<AccordionContentProps> = ({ children }) => {
  ...
  const accordionContext = useContext(AccordionContext);
  if (!accordionContext) throw new Error("AccordionContent must be used within an Accordion");
