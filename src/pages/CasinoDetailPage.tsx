...
export const CasinoDetailPage: React.FC = () => {
    const { id: casinoId } = useParams<{ id: string }>();
                ...
                {activeTab === 'vprs' && (
                    <div className="animate-tabSlideIn">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 bg-[#0c0c0e] p-6 rounded-xl border border-[#333]">
                             ...
                             <Button onClick={() => openReviewModal(casino.id)} className="w-full sm:w-auto font-heading uppercase tracking-wider shadow-[0_0_15px_rgba(0,255,192,0.2)]">
