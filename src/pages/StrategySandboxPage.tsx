...
export const StrategySandboxPage = () => {
    ...
    return (
        <div className="container mx-auto max-w-7xl p-4 py-6 md:p-10 page-fade-in min-h-[calc(100vh-4rem)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {SANDBOX_MODULES.map((mod, index) => (
                    <Card 
                        key={mod.id} 
                        className="group relative bg-[#1A1A1A] border-[#333] p-0 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-[#00FFC0] hover:shadow-[0_0_30px_rgba(0,255,192,0.15)] animate-fade-up"
